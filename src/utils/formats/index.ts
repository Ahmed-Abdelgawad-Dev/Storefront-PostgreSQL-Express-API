...
export const formatUser = (id: number | undefined, user_name: string, first_name: string, last_name: string, password: string): User => {
    return {
...
export const formatOrderDetails = (id: number, product_id: number, quantity: number, order_id: number): OrderDetails => {
